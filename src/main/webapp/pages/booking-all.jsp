...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/booking-all by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 08:55:26 GMT -->
<head>
			...
			<div class="container">
				...
				<div class="book-tab-inn">
					<ul class="nav nav-tabs">
					  <li class="active"><a data-toggle="tab" href="#home"><i class="fab fa-fly"></i> Travel Package</a></li>
					  <li><a data-toggle="tab" href="#menu1">Hotel Booking</a></li>
					...
					<div class="tab-content book-tab-body">
					  <div id="home" class="tab-pane fade in active">
						<div class="book-tab-tit">
							...
							<p>Experience the various exciting tour and travel packages and find vacation packages</p>
						</div>
						<form class="contact__form v2-search-form book-tab-form" method="post" action="https://rn53themes.net/themes/demo/travelz/mail/tourbooking.php">
					  ...
					  <div id="menu1" class="tab-pane fade">
						<div class="book-tab-tit">
							<h3>Hotel booking </h3>
							<p>Experience the various exciting cheap hotels and events</p>
						</div>
						<form class="contact__form v2-search-form book-tab-form" method="post" action="https://rn53themes.net/themes/demo/travelz/mail/hotelbooking.php">
							<div class="alert alert-success contact__msg" style="display: none" role="alert">
								Thank you message
							</div>
							<div class="row">
					  ...
					  <div id="menu2" class="tab-pane fade">
						...
						<form class="contact__form v2-search-form book-tab-form" method="post" action="https://rn53themes.net/themes/demo/travelz/mail/custombooking.php">
							<div class="alert alert-success contact__msg" style="display: none" role="alert">
					  ...
					  <div id="menu3" class="tab-pane fade">
						...
						<form class="contact__form v2-search-form book-tab-form" method="post" action="https://rn53themes.net/themes/demo/travelz/mail/carbooking.php">
							<div class="alert alert-success contact__msg" style="display: none" role="alert">
								Thank you message
							</div>
							<div class="row">
					  ...
					  <div id="menu4" class="tab-pane fade">
						...
						<form class="contact__form v2-search-form book-tab-form" method="post" action="https://rn53themes.net/themes/demo/travelz/mail/flightbooking.php">
							<div class="alert alert-success contact__msg" style="display: none" role="alert">
								Thank you message
							</div>
							<div class="row">
