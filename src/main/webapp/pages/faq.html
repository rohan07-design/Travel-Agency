...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 08:56:00 GMT -->
<head>
		...
		<div class="form form-spac rows">
			<div class="container">
				...
				<div class="col-md-6 col-sm-6 col-xs-12 form_1 faq-form wow fadeInLeft" data-wow-duration="1s">
					<!--====== THANK YOU MESSAGE ==========-->
					<form class="contact__form v2-search-form" method="post" action="https://rn53themes.net/themes/demo/travelz/mail/faq.php">
