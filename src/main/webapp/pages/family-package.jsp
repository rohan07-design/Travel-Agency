...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/family-package by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 08:55:36 GMT -->
<head>
            ...
            <div class="container inn-page-con-bg tb-space pad-bot-redu-5" id="inner-page-title">
                ...
                <div class="rows p2_2">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 p2">
                        ...
                        <div class="p2_book">
                            <ul>
                                <li><a href="booking" class="link-btn">Book Now</a>
                                </li>
                                <li><a href="tour-details" class="link-btn">View Package</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="footer1 home_title tb-space">
                <div class="pla1 container">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 foot-spec footer_places">
                        ...
                        <ul>
                            <li><a href="tour-details">Angkor Wat</a>
                            </li>
                            <li><a href="tour-details">Buckingham Palace</a>
                            </li>
                            <li><a href="tour-details">High Line</a>
                            </li>
                            <li><a href="tour-details">Sagrada Família</a>
                            </li>
                            <li><a href="tour-details">Statue of Liberty </a>
                            </li>
                            <li><a href="tour-details">Notre Dame de Paris</a>
                            </li>
                            <li><a href="tour-details">Taj Mahal</a>
                            </li>
                            <li><a href="tour-details">The Louvre</a>
                            </li>
                            <li><a href="tour-details">Tate Modern, London</a>
                            </li>
                            <li><a href="tour-details">Gothic Quarter</a>
                            </li>
                            <li><a href="tour-details">Table Mountain</a>
                            </li>
                            <li><a href="tour-details">Bayon</a>
                            </li>
                            <li><a href="tour-details">Great Wall of China</a>
                            </li>
                            <li><a href="tour-details">Hermitage Museum</a>
                            </li>
                            <li><a href="tour-details">Yellowstone</a>
                            </li>
                            <li><a href="tour-details">Musée d'Orsay</a>
                            </li>
                        </ul>
                    </div>
                </div>
