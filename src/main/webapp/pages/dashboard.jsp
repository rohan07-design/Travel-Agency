...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 08:55:36 GMT -->
<head>
		...
		<div class="db">
			...
			<div class="db-l">
				...
				<div class="db-l-2">
					<ul>
						<li>
							<a href="dashboard"><img src="images/icon/dbl1.png" alt="" /> All Bookings</a>
						</li>
						<li>
							<a href="db-travel-booking"><img src="images/icon/dbl2.png" alt="" /> Travel Bookings</a>
						</li>
						<li>
							<a href="db-hotel-booking"><img src="images/icon/dbl3.png" alt="" /> Hotel Bookings</a>
						</li>
						<li>
							<a href="db-event-booking"><img src="images/icon/dbl4.png" alt="" /> Event Bookings</a>
						</li>
						<li>
							<a href="db-my-profile"><img src="images/icon/dbl6.png" alt="" /> My Profile</a>
						</li>
						<li>
							<a href="db-all-payment"><img src="images/icon/dbl9.png" alt="" /> Payments</a>
						</li>
						<li>
							<a href="db-refund"><img src="images/icon/dbl7.png" alt="" /> Claim & Refund</a>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="db-2-main-com">
						<div class="db-2-main-1">
							<div class="db-2-main-2"> <img src="images/icon/db2.png" alt="" /><span>Travel Bookings</span>
								<ul>
									<li><a href="db-travel-details">Honeymoon Package</a>
									</li>
									<li><a href="db-payment">Payment Status <span class="db-done">Done</span></a>
									</li>
									<li><a href="db-travel-details">Remaining Days - 14</a>
									</li>
									<li><a href="db-travel-details">Travel Date - 16 may 2018</a>
									</li>
									<li><a href="db-refund">Cancel this booking</a>
									</li>
								</ul>
							</div>
						</div>
						<div class="db-2-main-1">
							<div class="db-2-main-2"> <img src="images/icon/db3.png" alt="" /><span>Hotel Bookings</span>
								<ul>
									<li><a href="db-hotel-details">GTC Grand Chola</a>
									</li>
									<li><a href="db-payment">Payment Status <span class="db-not-done">not-Done</span></a>
									</li>
									<li><a href="db-hotel-details">Remaining Days - 14</a>
									</li>
									<li><a href="db-hotel-details">Travel Date - 16 may 2018</a>
									</li>
									<li><a href="db-refund">Cancel this booking</a>
									</li>
								</ul>
						...
						<div class="db-2-main-1">
							<div class="db-2-main-2"> <img src="images/icon/db1.png" alt="" /><span>Event Bookings</span>
								<ul>
									<li><a href="db-event-details">Eiffel Tower Party</a>
									</li>
									<li><a href="db-payment">Payment Status <span class="db-not-done">not-Done</span></a>
									</li>
									<li><a href="db-event-details">Remaining Days - 14</a>
									</li>
									<li><a href="db-event-details">Travel Date - 16 may 2018</a>
									</li>
									<li><a href="db-refund">Cancel this booking</a>
									</li>
								</ul>
...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Jun 2023 08:55:43 GMT -->
</html>